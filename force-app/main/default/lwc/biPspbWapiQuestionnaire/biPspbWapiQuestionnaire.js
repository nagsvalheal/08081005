...
export default class BiPspbWapiQuestionnaire extends LightningElement {
	...
	outstandingQue = labels.OUT_STANDING_URL;
	...
	*/
	...
	firstKeyUp(event) {
		...
		if (this.inputValue >= 167) {
			this.firstNumberValue = this.inputValue;
	...
	secondKeyUp(event) {
		...
		this.inputValue = event.target.value
		if (this.inputValue >= 167) {
			this.secondNumberValue = this.inputValue;
	...
	thirdKeyUp(event) {
		...
		this.inputValue = event.target.value
		if (this.inputValue >= 167) {
			this.thirdNumberValue = this.inputValue;
			this.secondNumberValue = 0;
			this.firstNumberValue = 0;
		}
		this.checkAndUpdateValues();
	...
	*/
	...
	prepareResponseArrays() {
		...
		console.log('this.firstNumberValue b', this.firstNumberValue);
		console.log('came this.secondNumberValue b', this.secondNumberValue);
		console.log('came this.thirdNumberValue b', this.thirdNumberValue);

		console.log('this.secondRspValue', this.secondRspValue);
		console.log('came this.thirdRspValue b', this.thirdRspValue);
		console.log('came this.fourthRspValue b', this.fourthRspValue);
		if (this.firstNumberValue === '167' && this.secondRspValue !== '') {
		...
		if (this.secondNumberValue === '167' && this.thirdRspValue !== '') {
		...
		if (this.thirdNumberValue === '167' && this.fourthRspValue !== '') {
		...
		console.log('came this.sec', this.secondRspValue);
		console.log('came this.thirdRspValue', this.thirdRspValue);
		console.log('came this.fourthRspValue', this.fourthRspValue);
		console.log('came this.secondDraftResp', this.secondDraftResp);
		console.log('came this.thirdDraftResp', this.thirdDraftResp);
		console.log('came this.fourthDraftRes', this.fourthDraftRes);
		...
		if (this.firstNumberValue !== '') {
			console.log('this.secondRspValue 2', this.secondRspValue);
			console.log('this.secondRespVersId 2', this.secondRespVersId);
			...
			console.log('this.secondDraftResp 2.1', this.secondDraftResp);
			console.log('this.secondDraftVerionId 2.1', this.secondDraftVerionId);
			this.realRespArray.push(this.secondDraftResp);
			this.realAssesVerArra.push(this.secondDraftVerionId);
		}

		if (this.secondNumberValue !== '') {
			console.log('this.thirdRspValue 3', this.thirdRspValue);
			console.log('this.thirdVersionId 3', this.thirdVersionId);
			...
			console.log('this.thirdDraftResp 3.1', this.thirdDraftResp);
			console.log('this.thirdDraftVersionId 3.1', this.thirdDraftVersionId);
			this.realRespArray.push(this.thirdDraftResp);
			this.realAssesVerArra.push(this.thirdDraftVersionId);
		}
		if (this.thirdNumberValue !== '') {
			console.log('this.fourthRspValue 4', this.fourthRspValue);
			console.log('this.fourthVersionId 4', this.fourthVersionId);
			...
			console.log('this.fourthDraftRes 4.1', this.fourthDraftRes);
			console.log('this.fourthDraftVersionId 4.1', this.fourthDraftVersionId);
		...
		if (this.secondRspValue === '167' && this.firstRespBolean === false) {
			console.log('d 1');
			this.thirdRspValue = '0';
			this.thirdVersionId = this.thirdQuestionVersionId;
			this.fourthRspValue = '0';
		...
		if (this.thirdRspValue === '167' && this.secRespBolean === false) {
			console.log('d 2');
			this.secondRspValue = '0';
			this.secondRespVersId = this.secondQuestionVersinId;
			this.fourthRspValue = '0';
		...
		if (this.fourthRspValue === '167' && this.thirdRespBolean === false) {
			console.log('d 3');
			this.secondRspValue = '0';
			this.secondRespVersId = this.secondQuestionVersinId;
			this.thirdRspValue = '0';
		...
		console.log('this.secondRspValue 2 d', this.secondRspValue);
		console.log('this.secondRespVersId 2 d', this.secondRespVersId);
		console.log('this.thirdRspValue 3 d', this.thirdRspValue);
		console.log('this.thirdVersionId 3 d', this.thirdVersionId);
		console.log('this.fourthRspValue 4 d', this.fourthRspValue);
		console.log('this.fourthVersionId 4 d', this.fourthVersionId);
	}
	...
	submitResponses(draft, twoMonths) {
		...
		console.log('nonEmptyResponses', nonEmptyResponses.length);
		console.log('nonEmptyIds', nonEmptyIds.length);
	...
	saveAsDraft() {
		if (this.errorFlag !== true) {
			...
			let recordIdsToDelete = [
				...
				.filter(record => !record.value)
				.map(record => record.id);
			console.log('recordIdsToDelete:', recordIdsToDelete); // Logs filtered ids to console
