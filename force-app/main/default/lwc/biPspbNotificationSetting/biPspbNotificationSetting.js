...
let caseUpdate = {
	...
	this.updateFunc({ accids: this.accountName, type: resources.QUESTIONNAIRES, email: this.isCheckboxQuesEmail, sms: this.isCheckboxQuesSms, insite:true, phone: this.isCheckboxQuesPhone });
